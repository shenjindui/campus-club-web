            ...
            <el-tabs @tab-click="handleClick"><!--v-model="menu">-->
                <el-tab-pane :label="`社团信息列表(${pageParms.total})`" name="first" v-show="true">
                    ...
                    <template v-if="message === 'first'">
                        ...
                        <div class="handle-box">
                            <el-button type="warning" icon="search" @click="uodateStatus(isStatus)" plain v-if="isStatus">停用</el-button>
                            <el-button type="warning" icon="search" @click="uodateStatus(isStatus)" plain v-else>启用</el-button>
                        </div>
                        <p></p>
                        <div>
...
<script src="../../../style/js/clubisusered/clubisusered.js">
</script>
<style scoped>
