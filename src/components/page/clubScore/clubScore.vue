    ...
    <div class="">
        ...
        <div class="container">
            <el-tabs @tab-click="handleClick"><!--(${pageParms.total})-->
                <el-tab-pane :label="`未完成`" name="first" v-show="ratersPsccd=='0'">  <!--//展示未完成的-->
                    <el-dialog
                            title="提示"
                    ...
                    <template v-show="ratersPsccd=='0'">
                        ...
                        <div>
                            <el-table :data="ListData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                                ...
                                <el-table-column prop="stCd" label="所属社团编号" width="120" align="center" :show-overflow-tooltip="true"></el-table-column>
                        ...
                        <div class="pagination">
                            ...
                            <el-pagination
                                    ...
                                    @current-change="handleCurrentChange('0')"
                ...
                </el-tab-pane><!--(${pageParms.total2})-->
                <el-tab-pane :label="`已完成`" name="second" v-show="ratersPsccd=='1'">  <!--//展示完成的-->
                    <el-dialog
                            title="提示"
                            :visible.sync="dialogVisible"
                            width="30%"
