  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>公告详情编辑器</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
          ...
          <el-col :span="24">
            <el-form-item label="公告发布人时间：">
              <el-input type="text" :rows="1" placeholder="请输入内容" v-model="addForm.releaseTime"
                        style="width: 78%;" readonly="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row  label-width="80px" :gutter="16" type="flex">
          ...
          <el-col :span="24">
            <el-form-item label="公告访问量：">
              <el-input type="text" :rows="1" placeholder="请输入内容" v-model="addForm.trafficVolume"
                        style="width: 78%;color: red" readonly="true" ></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        this.$axios
                ...
                .then(successResponse => {
                  if (successResponse.data.status === 200) {
                    ...
                    this.addForm.releaseTime=this.dateFormate.dateformat(successResponse.data.data.releaseTime);
                  }
      ...
      back(){
        this.$router.push("/myClubnoticeList");
      }
    }
  }
</script>
