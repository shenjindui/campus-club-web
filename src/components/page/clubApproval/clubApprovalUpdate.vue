            ...
            <div class="rightForm">
                <div class="baseInfoForm">
                    <el-form ref="baseInfoForm" :model="baseInfoForm" label-width="100px">
                       <input type="hidden" v-model="baseInfoForm.uuid"></input>
                       <!-- <el-input v-model="baseInfoForm.uuid" placeholder="UUID" :aria-hidden="true"></el-input>-->
                        ...
                        <el-row :gutter="20" type="flex">
                            <el-col :span="9">
                                <el-form-item label="社团负责人">
                                    <el-input v-model="baseInfoForm.stChargeName" placeholder="社团负责人" :disabled="true"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="9">
                ...
                <div class="opnionForm">
                    <el-form ref="opinionForm" :model="opinionForm" label-width="100px" :rules="rules">
                        ...
                        <div class="submitStyle">
                            ...
                            <el-button type="primary" @click="startAndSubmit('opinionForm')" plain class="submitStyle">启动并提交</el-button>
                            <el-button type="primary" @click="back()" plain class="submitStyle">返回</el-button>
                        </div>
...
<script src="../../../style/js/clubApproval/clubApprovalUpdate.js">
