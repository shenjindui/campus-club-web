                ...
                <el-tab-pane :label="`系统登陆日志列表(${pageParms.total})`" name="first" v-show="true">
                    ...
                    <template v-if="message === 'first'">
                        <div class="handle-box">
                            <el-input  placeholder="用户编号" class="handle-input mr10" v-model="params.userNum"></el-input>
                            <el-input  placeholder="浏览器名称" class="handle-input mr10" v-model="params.browserName"></el-input>
                            <el-date-picker
                        ...
                        <p></p>
                        <div>
                            <el-table :data="loginLogListData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                                ...
                                <!--<el-table-column prop="osVersion" label="操作系统版本" width="120" align="center" :show-overflow-tooltip="true" ></el-table-column>-->
                        ...
                        <!-- //菜单详情的对话框 begin-->
                        <el-dialog title="登陆日志详情" :visible.sync="detailFormVisible" @close="menuDetailCancle('detailForm')">
