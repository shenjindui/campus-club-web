    ...
    <div class="">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-copy"></i> 社团反馈管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <el-tabs @tab-click="handleClick"><!--v-model="menu">-->
                <el-tab-pane :label="`社团反馈管理(${pageParms.total})`" name="first" v-show="true">
                    <!--//判断token是否过期合法的对话框-->
                    <el-dialog
                            title="提示"
                    ...
                    <template v-if="message === 'first'">
                        ...
                        <div class="handle-box">
                           <!-- <el-button type="primary" icon="search" @click="add()" plain>新增</el-button>-->
                            <el-button type="primary" icon="search" @click="edit()" plain>处理</el-button>
                        ...
                        <el-dialog title="修改反馈留言信息详情" :visible.sync="updateFormVisible" @close="UpdateCancle('updateForm')">
                            <el-form :model="updateForm" ref="updateForm" :rules="rules" >
                                <el-row :gutter="16" type="flex">
                                    <el-col :span="11">
                                        <el-form-item label="反馈留言UUID" :label-width="formLabelWidth">
                                            <el-input v-model.trim="updateForm.uuid" placeholder="反馈留言UUID" :disabled="true"></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="11">
                                        <el-form-item label="留言编号" :label-width="formLabelWidth">
                                            <el-input v-model.trim="updateForm.messageCd" placeholder="留言编号" :disabled="true"></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row :gutter="16" type="flex">
                                    ...
                                    <el-col :span="11">
                                        <el-form-item label="留言工号" :label-width="formLabelWidth" >
                                            <el-input v-model.trim="updateForm.messageSno" placeholder="留言工号" :disabled="true"></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row :gutter="16" type="flex">
                                    <el-col :span="11">
                                        <el-form-item label="留言人名字" :label-width="formLabelWidth" >
                                            <el-input v-model="updateForm.messageName" placeholder="留言人名字" :disabled="true" ></el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="11">
                                        <el-form-item label="留言状态" :label-width="formLabelWidth">
                                            <el-input v-model="updateForm.messagePsccdDdct" placeholder="留言状态" :disabled="true" ></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row :gutter="16" type="flex">
