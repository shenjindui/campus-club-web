            ...
            <el-tabs @tab-click="handleClick"><!--v-model="menu">-->
                ...
                <el-tab-pane :label="`已办事宜(${pageParmsSecond.total})`" name="second" v-show="secondVisiable">
                    ...
                    <template v-if="message === 'second'">
                        <!--<div class="handle-box">
                            <el-input  placeholder="工作流编号" class="handle-input mr10" v-model="paramsSecond.workFlowCode"></el-input>
                            <el-input  placeholder="系统业务编号" class="handle-input mr10" v-model="paramsSecond.businessCode"></el-input>
                            <el-button type="primary" icon="search" @click="search()">搜索</el-button>
                            <el-button type="primary" icon="reset" @click="reset()">重置</el-button>
                        </div>-->
                        <div class="handle-box">
...
<script src="../../../style/js/myClubApproval/myClubApproval.js">
</script>
<style scoped>
