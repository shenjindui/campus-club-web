    ...
    methods: {
        ...
        approver(){  //审核
            ...
            if(selectData.length>1){
                ...
                this.$router.push({path:'/stmanager/clubApproveInfo',query:{businessAssociationCode:selectData[0].businessAssociationCode,
                        uuid:selectData[0].uuid,userCode:selectData[0].userCode,businessCode:selectData[0].businessCode}});
            }
        },
        ...
        info(){
            ...
            if(selectData.length>1){
                ...
                //console.log(JSON.stringify(selectData[0]))
                this.$router.push({path:'/stmanager/clubApproveInfo',query:{businessAssociationCode:selectData[0].businessAssociationCode,
                        uuid:selectData[0].uuid,userCode:selectData[0].userCode,businessCode:selectData[0].businessCode,pageView:'disabled'}});
                /*this.$router.push({path:'/stmanager/clubApproveInfo',query:{businessAssociationCode:selectData[0].businessAssociationCode,
